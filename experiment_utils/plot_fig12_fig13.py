...
parser.add_argument('--throughput_data', type=str, required=True,
                    help="Path to the jsonl file containing the throughput "
                    "data, generated by gather_throughput_stats.py")
...
df = pd.read_json(args.throughput_data, lines=True)
