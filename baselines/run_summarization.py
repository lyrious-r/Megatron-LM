...
from dataset_from_mlm import DataCollatorForPackedDataset, get_train_ds, get_tokenizer
...
class DataTrainingArguments:
    ...
    data_path: Optional[str] = field(
        default=None, metadata={"help": "The path to the input dataset to use."}
    )
    target_data_path: Optional[str] = field(
        default=None, metadata={"help": "The path to the target dataset to use."}
    )
    vocab_file: Optional[str] = field(
        default=None, metadata={"help": "The path to the vocab file to use."}
    )
    global_batch_size: Optional[int] = field(
        default=None, metadata={"help": "The global batch size to use."}
    )
    ...
    def __post_init__(self):
        if (
            ...
            and self.vocab_file is None
            and self.global_batch_size is None
...
def main():
    ...
    train_dataset = get_train_ds(
        ...
        decoder_seq_length=data_args.max_target_length,
        pack_dataset=True,
    )
    ...
    data_collator = DataCollatorForPackedDataset(
        expected_length=data_args.max_source_length,
        expected_length_target=data_args.max_target_length,
