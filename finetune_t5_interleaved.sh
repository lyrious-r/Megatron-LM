...
python -m torch.distributed.launch $DISTRIBUTED_ARGS \
       ...
       --use-dynapipe \
       --dynapipe-cost-model /root/Megatron-LM/t5_3b_torch210.pkl \
       --dynapipe-device-to-node 0:0,1:0,2:0,3:0 \
       --dynapipe-device-memory-limit 35000 \
       --dynapipe-intra-node-bw 4800 \
       --dynapipe-inter-node-bw 100 \
       --dynapipe-layer-to-device 0,0,0,1,1,1,2,2,2,3,3,3,0,0,0,1,1,1,2,2,2,3,3,3 \
       --dynamic-batchsize \
       --tokens-per-global-batch 16384 \
       --dynapipe-prefetch-planner-num-workers 128 \
       --dynapipe-reserve-all-memory \
       --dynapipe-enable-packing \
       2>&1 | tee log_t5_3b_12l_dynapipe_interleaved_gbs16384_packed.txt
